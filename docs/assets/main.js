...
'use strict'; (() => {
  const Pe = Object.create; const ie = Object.defineProperty; const Oe = Object.getOwnPropertyDescriptor; const _e = Object.getOwnPropertyNames; const Re = Object.getPrototypeOf; const Me = Object.prototype.hasOwnProperty; const Fe = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports); const De = (t, e, n, r) => {
    if (e && typeof e == 'object' || typeof e == 'function') {
      for (const i of _e(e))!Me.call(t, i) && i !== n && ie(t, i, { get: () => e[i], enumerable: !(r = Oe(e, i)) || r.enumerable })
    } return t
  }; const Ae = (t, e, n) => (n = t != null ? Pe(Re(t)) : {}, De(e || !t || !t.__esModule ? ie(n, 'default', { value: t, enumerable: !0 }) : n, t)); const ue = Fe((ae, le) => {
    (function () {
...
`, e)
        ...
        for (let n = this._stack.length, r = 0; r < n; r++) {
          for (var i = this._stack[r], s = [], o = 0; o < e.length; o++) {
            const a = i(e[o], o, e); if (!(a == null || a === '')) {
              if (Array.isArray(a)) {
                for (let l = 0; l < a.length; l++)s.push(a[l])
              }
              else {
                s.push(a)
              }
        ...
        const e = { ational: 'ate', tional: 'tion', enci: 'ence', anci: 'ance', izer: 'ize', bli: 'ble', alli: 'al', entli: 'ent', eli: 'e', ousli: 'ous', ization: 'ize', ation: 'ate', ator: 'ate', alism: 'al', iveness: 'ive', fulness: 'ful', ousness: 'ous', aliti: 'al', iviti: 'ive', biliti: 'ble', logi: 'log' }; const n = { icate: 'ic', ative: '', alize: 'al', iciti: 'ic', ical: 'ic', ful: '', ness: '' }; const r = '[^aeiou]'; const i = '[aeiouy]'; const s = `${r}[^aeiouy]*`; const o = `${i}[aeiou]*`; const a = `^(${s})?${o}${s}`; const l = `^(${s})?${o}${s}(${o})?$`; const u = `^(${s})?${o}${s}${o}${s}`; const d = `^(${s})?${i}`; const m = new RegExp(a); const p = new RegExp(u); const b = new RegExp(l); const g = new RegExp(d); const L = /^(.+?)(ss|i)es$/; const f = /^(.+?)([^s])s$/; const y = /^(.+?)eed$/; const S = /^(.+?)(ed|ing)$/; const w = /.$/; const k = /(at|bl|iz)$/; const _ = new RegExp('([^aeiouylsz])\\1$'); const B = new RegExp(`^${s}${i}[^aeiouwxy]$`); const A = /^(.+?[^aeiou])y$/; const j = /^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/; const q = /^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/; const V = /^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/; const $ = /^(.+?)(s|t)(ion)$/; const C = /^(.+?)e$/; const z = /ll$/; const W = new RegExp(`^${s}${i}[^aeiouwxy]$`); const H = function (c) {
          let v, P, T, h, x, O, M; if (c.length < 3)
            return c; if (T = c.substr(0, 1), T == 'y' && (c = T.toUpperCase() + c.substr(1)), h = L, x = f, h.test(c) ? c = c.replace(h, '$1$2') : x.test(c) && (c = c.replace(x, '$1$2')), h = y, x = S, h.test(c)) { var E = h.exec(c); h = m, h.test(E[1]) && (h = w, c = c.replace(h, '')) }
          else if (x.test(c)) { var E = x.exec(c); v = E[1], x = g, x.test(v) && (c = v, x = k, O = _, M = B, x.test(c) ? c = `${c}e` : O.test(c) ? (h = w, c = c.replace(h, '')) : M.test(c) && (c = `${c}e`)) } if (h = A, h.test(c)) { var E = h.exec(c); v = E[1], c = `${v}i` } if (h = j, h.test(c)) { var E = h.exec(c); v = E[1], P = E[2], h = m, h.test(v) && (c = v + e[P]) } if (h = q, h.test(c)) { var E = h.exec(c); v = E[1], P = E[2], h = m, h.test(v) && (c = v + n[P]) } if (h = V, x = $, h.test(c)) { var E = h.exec(c); v = E[1], h = p, h.test(v) && (c = v) }
          else if (x.test(c)) { var E = x.exec(c); v = E[1] + E[2], x = p, x.test(v) && (c = v) } if (h = C, h.test(c)) { var E = h.exec(c); v = E[1], h = p, x = b, O = W, (h.test(v) || x.test(v) && !O.test(v)) && (c = v) } return h = z, x = p, h.test(c) && x.test(c) && (h = w, c = c.replace(h, '')), T == 'y' && (c = T.toLowerCase() + c.substr(1)), c
        }; return function (R) { return R.update(H) }
        ...
        for (var r = new t.TokenSet(), i = [{ node: r, editsRemaining: n, str: e }]; i.length;) {
          const s = i.pop(); if (s.str.length > 0) { const o = s.str.charAt(0); var a; o in s.node.edges ? a = s.node.edges[o] : (a = new t.TokenSet(), s.node.edges[o] = a), s.str.length == 1 && (a.final = !0), i.push({ node: a, editsRemaining: s.editsRemaining, str: s.str.slice(1) }) } if (s.editsRemaining != 0) {
            ...
            } if (s.str.length > 1) { const d = s.str.charAt(0); const m = s.str.charAt(1); var p; m in s.node.edges ? p = s.node.edges[m] : (p = new t.TokenSet(), s.node.edges[m] = p), s.str.length == 1 && (p.final = !0), i.push({ node: p, editsRemaining: s.editsRemaining - 1, str: d + s.str.slice(2) }) }
          }
        } return r
        ...
        for (var n = new t.TokenSet(), r = void 0, i = [{ qNode: e, output: n, node: this }]; i.length;) {
          r = i.pop(); for (let s = Object.keys(r.qNode.edges), o = s.length, a = Object.keys(r.node.edges), l = a.length, u = 0; u < o; u++) {
            for (let d = s[u], m = 0; m < l; m++) { const p = a[m]; if (p == d || d == '*') { const b = r.node.edges[p]; const g = r.qNode.edges[d]; const L = b.final && g.final; let f = void 0; p in r.output.edges ? (f = r.output.edges[p], f.final = f.final || L) : (f = new t.TokenSet(), f.final = L, r.output.edges[p] = f), i.push({ qNode: g, output: f, node: b }) } }
          }
        } return n
  ...
  }; function Ve(t) { const e = t.getBoundingClientRect(); const n = Math.max(document.documentElement.clientHeight, window.innerHeight); return !(e.bottom < 0 || e.top - n >= 0) } const oe = (t, e = 100) => { let n; return () => { clearTimeout(n), n = setTimeout(() => t(), e) } }; const pe = Ae(ue()); async function ce(t, e) {
    if (!window.searchData)
      return; const n = await fetch(window.searchData); const r = new Blob([await n.arrayBuffer()]).stream().pipeThrough(new DecompressionStream('gzip')); const i = await new Response(r).json(); t.data = i, t.index = pe.Index.load(i.index), e.classList.remove('loading'), e.classList.add('ready')
  } function fe() {
    const t = document.getElementById('tsd-search'); if (!t)
      return; const e = { base: `${t.dataset.base}/` }; const n = document.getElementById('tsd-search-script'); t.classList.add('loading'), n && (n.addEventListener('error', () => { t.classList.remove('loading'), t.classList.add('failure') }), n.addEventListener('load', () => { ce(e, t) }), ce(e, t)); const r = document.querySelector('#tsd-search input'); const i = document.querySelector('#tsd-search .results'); if (!r || !i)
  ...
  } function He(t, e, n, r) { n.addEventListener('input', oe(() => { Ne(t, e, n, r) }, 200)), n.addEventListener('keydown', (i) => { i.key == 'Enter' ? Be(e, t) : i.key == 'ArrowUp' ? (de(e, n, -1), i.preventDefault()) : i.key === 'ArrowDown' && (de(e, n, 1), i.preventDefault()) }), document.body.addEventListener('keypress', (i) => { i.altKey || i.ctrlKey || i.metaKey || !n.matches(':focus') && i.key === '/' && (i.preventDefault(), n.focus()) }), document.body.addEventListener('keyup', (i) => { t.classList.contains('has-focus') && (i.key === 'Escape' || !e.matches(':focus-within') && !n.matches(':focus')) && (n.blur(), te(t)) }) } function te(t) { t.classList.remove('has-focus') } function Ne(t, e, n, r) {
    if (!r.index || !r.data)
      return; e.textContent = ''; const i = n.value.trim(); let s; if (i) { const o = i.split(' ').map(a => a.length ? `*${a}*` : '').join(' '); s = r.index.search(o) }
    else {
      s = []
    } for (let o = 0; o < s.length; o++) { const a = s[o]; const l = r.data.rows[Number(a.ref)]; let u = 1; l.name.toLowerCase().startsWith(i.toLowerCase()) && (u *= 1 + 1 / (1 + Math.abs(l.name.length - i.length))), a.score *= u } if (s.length === 0) { const o = document.createElement('li'); o.classList.add('no-results'); const a = document.createElement('span'); a.textContent = 'No results found', o.appendChild(a), e.appendChild(o) }s.sort((o, a) => a.score - o.score); for (let o = 0, a = Math.min(10, s.length); o < a; o++) {
      const l = r.data.rows[Number(s[o].ref)]; const u = `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" class="tsd-kind-icon"><use href="#icon-${l.kind}"></use></svg>`; let d = he(l.name, i); globalThis.DEBUG_SEARCH_WEIGHTS && (d += ` (score: ${s[o].score.toFixed(2)})`), l.parent && (d = `<span class="parent">
                ${he(l.parent, i)}.</span>${d}`); const m = document.createElement('li'); m.classList.value = l.classes ?? ''; const p = document.createElement('a'); p.href = r.base + l.url, p.innerHTML = u + d, m.append(p), p.addEventListener('focus', () => { e.querySelector('.current')?.classList.remove('current'), m.classList.add('current') }), e.appendChild(m)
    }
  } function de(t, e, n) {
    let r = t.querySelector('.current'); if (!r) {
      r = t.querySelector(n == 1 ? 'li:first-child' : 'li:last-child'), r && r.classList.add('current')
    }
    else {
      let i = r; if (n === 1) {
        do i = i.nextElementSibling ?? void 0; while (i instanceof HTMLElement && i.offsetParent == null)
      }
      else {
        do i = i.previousElementSibling ?? void 0; while (i instanceof HTMLElement && i.offsetParent == null)
      }i ? (r.classList.remove('current'), i.classList.add('current')) : n === -1 && (r.classList.remove('current'), e.focus())
    }
  } function Be(t, e) { let n = t.querySelector('.current'); if (n || (n = t.querySelector('li:first-child')), n) { const r = n.querySelector('a'); r && (window.location.href = r.href), te(e) } } function he(t, e) {
    if (e === '')
      return t; const n = t.toLocaleLowerCase(); const r = e.toLocaleLowerCase(); const i = []; let s = 0; let o = n.indexOf(r); for (;o != -1;)i.push(ee(t.substring(s, o)), `<b>${ee(t.substring(o, o + r.length))}</b>`), s = o + r.length, o = n.indexOf(r, s); return i.push(ee(t.substring(s))), i.join('')
  } const je = { '&': '&amp;', '<': '&lt;', '>': '&gt;', '\'': '&#039;', '"': '&quot;' }; function ee(t) { return t.replace(/[&<>"']/g, e => je[e]) } const I = class {constructor(e) { this.el = e.el, this.app = e.app }}; let F = 'mousedown'; let ye = 'mousemove'; let N = 'mouseup'; const J = { x: 0, y: 0 }; let me = !1; let ne = !1; let qe = !1; let D = !1; const ve = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent); document.documentElement.classList.add(ve ? 'is-mobile' : 'not-mobile'); ve && 'ontouchstart' in document.documentElement && (qe = !0, F = 'touchstart', ye = 'touchmove', N = 'touchend'); document.addEventListener(F, (t) => { ne = !0, D = !1; const e = F == 'touchstart' ? t.targetTouches[0] : t; J.y = e.pageY || 0, J.x = e.pageX || 0 }); document.addEventListener(ye, (t) => { if (ne && !D) { const e = F == 'touchstart' ? t.targetTouches[0] : t; const n = J.x - (e.pageX || 0); const r = J.y - (e.pageY || 0); D = Math.sqrt(n * n + r * r) > 10 } }); document.addEventListener(N, () => { ne = !1 }); document.addEventListener('click', (t) => { me && (t.preventDefault(), t.stopImmediatePropagation(), me = !1) }); const X = class extends I {
    constructor(e) { super(e), this.className = this.el.dataset.toggle || '', this.el.addEventListener(N, n => this.onPointerUp(n)), this.el.addEventListener('click', n => n.preventDefault()), document.addEventListener(F, n => this.onDocumentPointerDown(n)), document.addEventListener(N, n => this.onDocumentPointerUp(n)) }setActive(e) {
      if (this.active == e)
    ...
    onPointerUp(e) { D || (this.setActive(!0), e.preventDefault()) }onDocumentPointerDown(e) {
      if (this.active) {
    ...
    onDocumentPointerUp(e) { if (!D && this.active && e.target.closest('.col-sidebar')) { const n = e.target.closest('a'); if (n) { let r = window.location.href; r.includes('#') && (r = r.substring(0, r.indexOf('#'))), n.href.substring(0, r.length) == r && setTimeout(() => this.setActive(!1), 250) } } }
  }; let re; try { re = localStorage }
  catch { re = { getItem() { return null }, setItem() {} } } const Q = re; const ge = document.head.appendChild(document.createElement('style')); ge.dataset.for = 'filters'; const Y = class extends I {
    constructor(e) {
...
`, this.app.updateIndexVisibility()
  ...
  }; const Z = class extends I {constructor(e) { super(e), this.summary = this.el.querySelector('.tsd-accordion-summary'), this.icon = this.summary.querySelector('svg'), this.key = `tsd-accordion-${this.summary.dataset.key ?? this.summary.textContent.trim().replace(/\s+/g, '-').toLowerCase()}`; const n = Q.getItem(this.key); this.el.open = n ? n === 'true' : this.el.open, this.el.addEventListener('toggle', () => this.update()); const r = this.summary.querySelector('a'); r && r.addEventListener('click', () => { location.assign(r.href) }), this.update() }update() { this.icon.style.transform = `rotate(${this.el.open ? 0 : -90}deg)`, Q.setItem(this.key, this.el.open.toString()) }}; function Ee(t) { const e = Q.getItem('tsd-theme') || 'os'; t.value = e, xe(e), t.addEventListener('change', () => { Q.setItem('tsd-theme', t.value), xe(t.value) }) } function xe(t) { document.documentElement.dataset.theme = t } let K; function we() { const t = document.getElementById('tsd-nav-script'); t && (t.addEventListener('load', Le), Le()) } async function Le() {
    const t = document.getElementById('tsd-nav-container'); if (!t || !window.navigationData)
      return; const n = await (await fetch(window.navigationData)).arrayBuffer(); const r = new Blob([n]).stream().pipeThrough(new DecompressionStream('gzip')); const i = await new Response(r).json(); K = t.dataset.base, K.endsWith('/') || (K += '/'), t.innerHTML = ''; for (const s of i)Se(s, t, []); window.app.createComponents(t), window.app.showPage(), window.app.ensureActivePageVisible()
  } function Se(t, e, n) {
    const r = e.appendChild(document.createElement('li')); if (t.children) { const i = [...n, t.text]; const s = r.appendChild(document.createElement('details')); s.className = t.class ? `${t.class} tsd-accordion` : 'tsd-accordion'; const o = s.appendChild(document.createElement('summary')); o.className = 'tsd-accordion-summary', o.dataset.key = i.join('$'), o.innerHTML = '<svg width="20" height="20" viewBox="0 0 24 24" fill="none"><use href="#icon-chevronDown"></use></svg>', be(t, o); const a = s.appendChild(document.createElement('div')); a.className = 'tsd-accordion-details'; const l = a.appendChild(document.createElement('ul')); l.className = 'tsd-nested-navigation'; for (const u of t.children)Se(u, l, i) }
    else {
      be(t, r, t.class)
    }
  } function be(t, e, n) {
    if (t.path) { const r = e.appendChild(document.createElement('a')); r.href = K + t.path, n && (r.className = n), location.pathname === r.pathname && !r.href.includes('#') && r.classList.add('current'), t.kind && (r.innerHTML = `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" class="tsd-kind-icon"><use href="#icon-${t.kind}"></use></svg>`), r.appendChild(document.createElement('span')).textContent = t.text }
    else {
      e.appendChild(document.createElement('span')).textContent = t.text
    }
  }G(X, 'a[data-toggle]'); G(Z, '.tsd-accordion'); G(Y, '.tsd-filter-item input[type=checkbox]'); const Te = document.getElementById('tsd-theme'); Te && Ee(Te); const $e = new U(); Object.defineProperty(window, 'app', { value: $e }); fe(); we()
})()
