...
- [x] **Phase 74: Demo design cohesion** — claude-design packet implemented: EWA token layer + Signal-green brand, 12-SFC kit (`kit/`), all 22 demos + PianoKeyboard restyled, dark/light parity, ≥44px touch, AA sweep, IA triage (2 renames adopted, structural items to M8-QUESTIONS). Exit gate green (1944+31 unit, 72/72 E2E). ✓ 2026-07-10
- [~] **Phase 75: Demo sound quality** — Shared master bus (limiter + peak meter via new core `setMasterDestination` hook), objective loudness E2E (17 demos, 0.05 ≤ peak ≤ 0.985), gain-staged 4 clippers, preset audit. Code complete + exit gate green; **awaiting HUMAN GATE 2 (listening)** before Phase 76 unblocks. (2026-07-10)
...
- [x] **Phase 77: @ez-web-audio/react** — 15 hooks mirroring Vue 1:1 (uniform shape incl. reset), SSR/StrictMode-safe, 34 TDD tests, `examples/react-basic` StackBlitz app (embed live post-publish), integration guide rewritten on the real package. Exit gate green. ✓ 2026-07-10
